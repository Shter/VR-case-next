...
export function Footer() {
    return (
        <footer className="bg-dark text-white pt-16 pb-6">
            <div className="container grid grid-cols-2 gap-10 sm:grid-cols-3 md:grid-cols-4">
                <div>
                    ...
                    <p>
                        Servicio de alquiler de VR Meta Quest 3 para eventos, activaciones y experiencias privadas en
                        Buenos Aires
                    </p>
                </div>
                <div>
                    <h3 className="mb-4 text-xl text-secondary">Menú</h3>
                ...
                <div>
                    <h3 className="mb-4 text-xl text-secondary">Servicios</h3>
                    <ul className="space-y-2">
                ...
                <div>
                    <h3 className="mb-4 text-xl text-secondary">Contactos</h3>
                    <address className="not-italic leading-6">
                        VR.CASE
                        <br/>
                        Buenos Aires, Argentina
                        <br/>
                        Teléfono: +541127827150
                    </address>
